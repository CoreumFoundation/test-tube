...
require (
	...
	github.com/osmosis-labs/osmosis/v19 v19.0.0-rc0
...
replace github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.45.0-rc1.0.20230703010110-ed4eb883f2a6
